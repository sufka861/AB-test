...
experimentRouter.get(
  "/account/:accountId",
  experimentController.getExperimentsByAccountId
);
experimentRouter.get("/date", experimentController.getExperimentsByDate);
experimentRouter.get(
  "/allowChangeAttribute/:accountId",
  experimentController.allowChangeAttribute
);
...
experimentRouter.put(
  "/:experimentId",
  experimentController.updateExperimentsByID
);
experimentRouter.put(
  "/:experimentId/:goalId",
  experimentController.addGoalToExperiment
);
experimentRouter.put(
  "/terminate/:experimentId",
  experimentController.terminateExperiment
);
experimentRouter.delete(
  "/:experimentId/:goalId",
  experimentController.removeGoalFromExperiment
);
experimentRouter.delete(
  "/:experimentId",
  experimentController.deleteExperimentsByID
);
experimentRouter.post(
  "/new",
  newExperimentController.createExperimentWithGoals
);
